...
import com.company.thedecorum.Vase;
import com.company.thedecorum.VaseAdapter;
...
public class VaseFragment extends Fragment implements VaseAdapter.AbcOnClickListener {

    private RecyclerView Recyclerview;
    private MainActivity mainActivity;
    private VaseAdapter adapter;
    private ArrayList<Vase> list;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_vase, container, false);
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Vase");
        Recyclerview.setHasFixedSize(true);
        Recyclerview.addItemDecoration(new DividerItemDecoration(
                Recyclerview.getContext(),DividerItemDecoration.VERTICAL
        ));
        Recyclerview.setLayoutManager(new GridLayoutManager(getActivity(),2));
        adapter = new VaseAdapter(getActivity(),list);
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            if(dataSnapshot.exists()){
                ...
                for(DataSnapshot snapshot:dataSnapshot.getChildren()){
                    Vase p = snapshot.getValue(Vase.class);
                    list.add(p);
                }
