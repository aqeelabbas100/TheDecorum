...
public class VaseAdapter extends RecyclerView.Adapter<VaseAdapter.MyHolder> implements Filterable {
    public ArrayList<Vase> vases;
    private Context context;
    private List<Vase> list,filterList;
    private AbcOnClickListener listener;
    CustomFilter filter;


    public VaseAdapter(Context context, ArrayList<Vase> list) {
        this.context = context;
        this.list = list;
        this.filterList = list;
    }

    public VaseAdapter(FirebaseRecyclerOptions<Vase> options) {
        super();
    }

    @NonNull
    @Override
    public VaseAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull VaseAdapter.MyHolder abc, int i) {
        Vase p = filterList.get(i);
