...
public class LampAdapter extends RecyclerView.Adapter<LampAdapter.MyHolder> implements Filterable {
    ...
    public LampAdapter(LampActivity context, ArrayList<Lamp> list) {
    ...
    @Override
    public void onBindViewHolder(@NonNull  LampAdapter.MyHolder abc, int position) {
        Lamp l = filterList.get(position);

        abc.tvshowname.setText(l.name);
        abc.tvshowsize.setText(l.size);
        abc.tvshowprice.setText(l.price);



        Picasso.get().load(l.imageurl).into(abc.imageView);
    }

  /*  @Override
    public void onBindViewHolder(@NonNull ProductAdapter.MyHolder abc, int i) {
