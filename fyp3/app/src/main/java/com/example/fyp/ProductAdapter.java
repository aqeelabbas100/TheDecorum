...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.MyHolder> implements Filterable {
    ...
    public ProductAdapter(MainActivity context, ArrayList<Product> list) {
    ...
    @NonNull
    @Override
    public ProductAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
